...
const TOTAL_FACTURAS = `(f.tasa_uso + f.hospedaje + f.mantenimiento + COALESCE(SUM(g.valor), 0))`;

// Saldo real = anticipo - total_facturas
const SALDO_REAL = `(f.anticipo - ${TOTAL_FACTURAS})`;
