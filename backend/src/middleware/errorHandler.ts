...
import { ENTORNO_PRODUCCION } from '../utils/config.ts';

/** Forma de los errores que puede recibir el manejador (Error nativo, HttpError, SqliteError, body-parser…). */
 ...
 */
// Express reconoce el manejador de errores por sus cuatro parámetros: _next debe quedarse.
export function errorHandler(err: ErrorConCodigo, req: Request, res: Response, _next: NextFunction) {
