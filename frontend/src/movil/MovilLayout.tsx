...
// Evento no estándar de Chrome/Android (no está en los tipos del DOM)
...
let promptInstalacion: BeforeInstallPromptEvent | null = null
if (typeof window !== 'undefined') {
  window.addEventListener('beforeinstallprompt', (e) => { e.preventDefault(); promptInstalacion = e as BeforeInstallPromptEvent })
}
const esiOS = (): boolean => /iphone|ipad|ipod/i.test(navigator.userAgent)
...
interface Props {
  titulo: string
  /** Ruta del botón «Volver»; sin ella se muestra el logo. */
  atras?: string
  children: ReactNode
  onCambiarPassword: () => void
}

export default function MovilLayout({ titulo, atras, children, onCambiarPassword }: Props) {
