...
function PrimerUsuario({ puedeConfigurar }: { puedeConfigurar: boolean }) {
  ...
  const distinta = Boolean(f.repetir) && f.password !== f.repetir
  ...
  return (
    <form onSubmit={onSubmit} aria-labelledby="setup-titulo">
      ...
      <div className="space-y-4">
        ...
        <button type="submit" disabled={enviando || distinta} className="btn-primary btn-lg w-full shadow-card">
